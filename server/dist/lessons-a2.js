...
exports.a2Lessons = void 0;
const content_builders_1 = require("./content-builders");
exports.a2Lessons = [
    (0, content_builders_1.createLesson)(9, "Shopping and Money", "A2", 28, "Handle price questions, quantity, requests, and simple bargaining language.", "Market, kirana, mall ya pharmacy mein kaam aane wali English isi lesson mein hai. Price aur quantity bolna ab easy hoga.", 8, [
        (0, content_builders_1.createChapter)("l09-prices-quantities", "Prices and Quantities", "Daam aur quantity bolna", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l09-shop-requests", "Requesting in a Shop", "Shop mein politely maangna", "speaking", [
        ...
        (0, content_builders_1.createChapter)("l09-countable-uncountable", "Countable and Uncountable Shopping Words", "Many, much, some ka use", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l09-store-roleplay", "Market Roleplay Review", "Shopping ka quick roleplay", "quiz", [
    ...
    (0, content_builders_1.createLesson)(10, "Talking About the Past", "A2", 30, "Describe finished actions from yesterday, last week, or earlier with clear verbs.", "Kal kya hua, pichhle hafte kya kiya, ya bachpan mein kya hota tha, uski basic English yahan se strong hogi.", 9, [
        (0, content_builders_1.createChapter)("l10-past-time-words", "Past Time Words", "Yesterday, last week, ago jaise words", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l10-regular-verbs", "Regular Verbs in the Past", "Worked, played, visited ka pattern", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l10-irregular-verbs", "Irregular Past Verbs", "Went, saw, ate jaise special verbs", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l10-story-speaking", "Tell a Short Past Story", "Pichhle din ki chhoti kahani sunao", "speaking", [
    ...
    (0, content_builders_1.createLesson)(11, "Making Plans — Future Tense", "A2", 24, "Talk about weekend plans, promises, and future arrangements with confidence.", "Agle hafte, weekend, ya future goal ke baare mein bolne ke liye will aur going to ko simple tarike se use karna seekho.", 10, [
        (0, content_builders_1.createChapter)("l11-future-words", "Words for Future Plans", "Future planning wale useful words", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l11-will-vs-going-to", "Will vs Going To", "Promise aur plan mein difference", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l11-arrange-plan", "Arrange a Plan with Someone", "Kisi ke saath plan fix karna", "speaking", [
    ...
    (0, content_builders_1.createLesson)(12, "Expressing Opinions", "A2", 22, "Share what you think, agree politely, and add a simple reason.", "Sirf answer dena enough nahi hota. Opinion dena aur uska reason batana conversation ko strong banata hai.", 11, [
        (0, content_builders_1.createChapter)("l12-opinion-starters", "Opinion Starters", "Mere hisaab se kaise bolte hain", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l12-agree-disagree", "Agreeing and Disagreeing Politely", "Haan ya naa ko politely bolna", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l12-opinion-reason", "Give a Reason with Your Opinion", "Opinion ke saath reason jodo", "quiz", [
