...
exports.b1Lessons = void 0;
const content_builders_1 = require("./content-builders");
exports.b1Lessons = [
    (0, content_builders_1.createLesson)(13, "Workplace English — Meetings", "B1", 30, "Speak in meetings with updates, clarifications, and polite interruptions.", "Office meetings mein sirf sunna nahi, balki update dena, point clear karna aur politely bolna bhi zaroori hota hai.", 12, [
        (0, content_builders_1.createChapter)("l13-meeting-phrases", "Core Meeting Phrases", "Meeting mein kaam aane wale phrases", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l13-giving-updates", "Giving a Clear Update", "Status update ko clearly bolna", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l13-clarifying", "Clarifying and Interrupting Politely", "Beech mein politely clear karna", "speaking", [
        ...
        (0, content_builders_1.createChapter)("l13-summary-review", "Meeting Summary Review", "Meeting ke baad summary banana", "quiz", [
    ...
    (0, content_builders_1.createLesson)(14, "Email Writing", "B1", 28, "Write cleaner work emails with strong openings, requests, and closings.", "Professional email likhna job life ka daily part hai. Yeh lesson tumhe formal aur clear email flow sikhaata hai.", 13, [
        (0, content_builders_1.createChapter)("l14-openings", "Subject Lines and Openings", "Email ka subject aur opening", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l14-structure", "Formal Email Structure", "Email ko logical blocks mein likhna", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l14-followups", "Requests and Follow-Ups", "Email mein request aur follow-up karna", "speaking", [
        ...
        (0, content_builders_1.createChapter)("l14-tone-check", "Tone Check Quiz", "Formal tone ka quick check", "quiz", [
    ...
    (0, content_builders_1.createLesson)(15, "Telling Stories — Past Continuous", "B1", 26, "Set a scene, describe ongoing past action, and tell better spoken stories.", "Story bolte waqt sirf kya hua nahi, balki kya chal raha tha yeh batana bhi important hota hai.", 14, [
        (0, content_builders_1.createChapter)("l15-scene-setting", "Setting the Scene", "Story ka background banana", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l15-interrupted-actions", "Interrupted Actions", "Ek kaam chal raha tha, doosra beech mein hua", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l15-storytelling", "Tell a Better Story Aloud", "Story ko engaging tarike se sunao", "speaking", [
    ...
    (0, content_builders_1.createLesson)(16, "Problem Solving Language", "B1", 24, "Describe issues, suggest solutions, and escalate clearly in work or service contexts.", "Problem ko calm aur clear English mein explain karna workplace aur customer situations dono mein bahut zaroori skill hai.", 15, [
        (0, content_builders_1.createChapter)("l16-describe-problem", "Describing the Problem Clearly", "Issue ko clearly explain karna", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l16-suggest-solutions", "Suggesting Solutions", "Solution politely suggest karna", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l16-escalation", "Escalation Roleplay", "Issue ko aage raise karna", "speaking", [
    ...
    (0, content_builders_1.createLesson)(17, "Connecting Ideas — Discourse Markers", "B1", 28, "Use connectors like however, therefore, and in addition to sound more fluent.", "Sentence alag-alag bolna easy hota hai, lekin ideas ko smoothly jodna fluency ka real sign hota hai.", 16, [
        (0, content_builders_1.createChapter)("l17-adding-ideas", "Adding Ideas Smoothly", "Also, in addition, moreover ka use", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l17-contrast-result", "Contrast and Result Markers", "However, so, therefore ka use", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l17-structured-answer", "Structuring a Longer Answer", "Long answer ko flow ke saath bolna", "speaking", [
        ...
        (0, content_builders_1.createChapter)("l17-connectors-quiz", "Connector Choice Quiz", "Sahi connector ka selection", "quiz", [
    ...
    (0, content_builders_1.createLesson)(18, "Job Interview Preparation", "B1", 34, "Prepare stronger interview answers for strengths, experience, and closing questions.", "Interview mein English ke saath structure bhi matter karta hai. Yeh lesson tumhe ready-made confidence deta hai.", 17, [
        (0, content_builders_1.createChapter)("l18-strengths", "Talking About Your Strengths", "Apni strengths ko smartly batana", "vocabulary", [
        ...
        (0, content_builders_1.createChapter)("l18-experience", "Answering Experience Questions", "Experience wale sawalon ka flow", "grammar", [
        ...
        (0, content_builders_1.createChapter)("l18-star-method", "STAR Method for Better Answers", "Situation, Task, Action, Result", "speaking", [
        ...
        (0, content_builders_1.createChapter)("l18-salary-availability", "Salary, Availability, and Notice Period", "Sensitive sawalon ko calmly handle karo", "listening", [
        ...
        (0, content_builders_1.createChapter)("l18-interview-closing", "Strong Interview Closing", "Interview ko achhe se close karna", "quiz", [
