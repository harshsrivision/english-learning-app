...
export const foundationLessons: Lesson[] = [
  createLesson(
    ...
    "A0",
    18,
    "Recognize letters, say basic sounds, and start reading tiny words aloud.",
    "English ki bilkul shuruaat. A, B, C ko dekhna hi nahi, unki sound bhi pakadni hai.",
    null,
    [
      createChapter(
        "l01-letter-names",
        "Letter Names from A to Z",
        "A se Z tak letters ko pehchano",
        "vocabulary",
        [
  ...
  createLesson(
    2,
    "First 50 Survival Words",
    "A0",
    20,
    "Build a first bank of everyday words used at home, on the street, and in class.",
    "Yeh lesson tumhe roz ke kaam aane wale words deta hai jinse mini sentences turant ban sakte hain.",
    1,
    [
      createChapter(
        "l02-everyday-nouns",
        "Everyday Nouns",
        "Roz ke kaam aane wale nouns",
        "vocabulary",
        [
      ...
      createChapter(
        ...
        "Roz use hone wale action verbs",
        "vocabulary",
        [
      ...
      createChapter(
        "l02-polite-words",
        "Polite Words for Survival English",
        "Please, sorry, thank you ka smart use",
        "quiz",
        [
  ...
  createLesson(
    ...
    "A0",
    18,
    "Talk about simple counting, colors around you, and the objects in front of you.",
    "Ab tum room ke aas-paas ki cheezein English mein bolna start karoge: numbers, colors aur objects ke saath.",
    2,
    [
      createChapter(
        "l03-numbers",
        "Numbers 1 to 20",
        "1 se 20 tak counting",
        "vocabulary",
        [
      ...
      createChapter(
        ...
        "Paas aur door wali cheezon ko bolo",
        "grammar",
        [
  ...
  createLesson(
    ...
    "A0",
    16,
    "Start and end basic conversations politely in social and public situations.",
    "Kisi se milte waqt kya bolna hai aur nikalte waqt kaise politely close karna hai, yeh lesson usi confidence ke liye hai.",
    3,
    [
      createChapter(
        "l04-greetings",
        "Common Greetings",
        "Milte waqt bole jaane wale greetings",
        "vocabulary",
        [
      ...
      createChapter(
        "l04-questions-after-greeting",
        "Small Questions After Greeting",
        "Greeting ke baad chhote questions",
        "speaking",
        [
      ...
      createChapter(
        "l04-goodbyes",
        "Goodbyes and Leaving Politely",
        "Baat khatam karte waqt kya bolna hai",
        "listening",
        [
  ...
  createLesson(
    ...
    "A1",
    24,
    "Say your name, city, work, and interests in a clean beginner introduction.",
    "Ab tum apna naam, shehar, kaam aur hobbies ko milaakar ek proper self-introduction bolna seekhoge.",
    4,
    [
      createChapter(
        "l05-name-city",
        "Name and City",
        "Naam aur shehar batana",
        "speaking",
        [
      ...
      createChapter(
        "l05-work-study",
        "Work or Study Introduction",
        "Apna kaam ya padhai batana",
        "grammar",
        [
      ...
      createChapter(
        "l05-full-introduction",
        "Build Your Full Introduction",
        "Apna full introduction jodo",
        "quiz",
        [
  ...
  createLesson(
    ...
    "A1",
    20,
    "Describe parents, siblings, and relationships with easy sentence patterns.",
    "Family ke baare mein English mein bolna daily conversation ka basic hissa hai. Yeh lesson usi ko natural banata hai.",
    5,
    [
      createChapter(
        "l06-family-words",
        "Family Member Vocabulary",
        "Family members ke English words",
        "vocabulary",
        [
      ...
      createChapter(
        ...
        "Rishton ko sentence mein batana",
        "grammar",
        [
      ...
      createChapter(
        "l06-family-speaking",
        "Describe Your Family in 4 Lines",
        "Apni family ko 4 lines mein batao",
        "speaking",
        [
  ...
  createLesson(
    ...
    "A1",
    26,
    "Explain your routine with time words, habit verbs, and present simple structure.",
    "Roz subah se raat tak kya karte ho, usse simple aur correct English mein bolna is lesson ka main target hai.",
    6,
    [
      createChapter(
        "l07-morning-routine",
        "Morning Routine Vocabulary",
        "Subah ke routine wale words",
        "vocabulary",
        [
      ...
      createChapter(
        ...
        "Habit batane ke liye present simple",
        "grammar",
        [
      ...
      createChapter(
        ...
        "Always, usually, sometimes ka use",
        "grammar",
        [
      ...
      createChapter(
        "l07-full-day-speaking",
        "Speak About Your Full Day",
        "Apne poore din ka short speaking",
        "speaking",
        [
  ...
  createLesson(
    ...
    "A1",
    22,
    "Ask for information using WH questions, yes/no questions, and polite forms.",
    "Question puchhna conversation ka engine hota hai. Yeh lesson tumhe simple aur polite dono tarah ke sawaal banana sikhata hai.",
    7,
    [
      createChapter(
        "l08-wh-words",
      ...
      createChapter(
        "l08-yes-no-questions",
        "Yes/No Question Patterns",
        "Do, does, is, are ke saath questions",
        "grammar",
        [
      ...
      createChapter(
        "l08-polite-questions",
        "Polite Questions for Real Life",
        "Polite aur soft sawaal kaise puchhein",
        "speaking",
        [
